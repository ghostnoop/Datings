...
class DiscoverActivity : AppCompatActivity() {
    ...
    private fun setDataToAdapter(locationList: List<HumanModel>) {

        locationViewPager.adapter = HumanModelAdapter(this, locationList) { adapterPosition ->
//
...
//            startActivity(intent)
    ...
    companion object {
        fun getHUMANSGIRl(): List<HumanModel> {
            return listOf(
                HumanModel(
                    "Angelina",
                    "Photographer",
                ...
                HumanModel(
                    "Jennie Howells",
                    "Actor",
                    "https://images.unsplash.com/photo-1520512202623-51c5c53957df?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9",
                    27,
                    false,
                    Message(0, 4, "", "Jennie Howells")
                ),
        ...
        fun getHUMANSMan(): List<HumanModel> {
            return listOf(
